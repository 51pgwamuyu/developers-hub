              ...
              <div className=" mt-3  p-[30px] ">
                <div className="">
                  ...
                  <div className="flex flex-col mt-6 mb-7">
                    ...
                    <input type="text" value={username} className="border" required onChange={(e)=>setUserName(e.target.value)} />
                  </div>
                  <div className="flex flex-col mt-6 mb-7">
                  <Label className="mb-4">Tell us About You</Label>
                    <textarea rows={4} className="border" maxLength={200} required value={bio} onChange={(e)=>setBio(e.target.value)} placeholder="your bio..."></textarea>
                  </div>

                </div>
              </div>
              <Button type="submit" variant="blue">Save your Changes</Button>
            </form>
          </div>
        </div>
      </div>
